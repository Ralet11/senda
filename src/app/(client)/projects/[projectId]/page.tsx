      ...
      <section className="senda-project-hero relative overflow-hidden rounded-[1.45rem] border border-zinc-200 p-6 text-white shadow-sm">
        <div className="flex flex-col gap-6 xl:flex-row xl:items-start xl:justify-between">
          <div className="space-y-3">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-zinc-950">{project.name}</h2>
          ...
          <div className="grid min-w-[280px] gap-3 rounded-lg border border-zinc-200 bg-zinc-100 p-4">
            <div className="grid grid-cols-[72px_minmax(0,1fr)] items-center gap-4 rounded-md border border-zinc-200 bg-white/55 px-3 py-3">
              <div className="relative h-16 w-16 rounded-full border border-zinc-200 bg-zinc-100">
                <div
                ...
                />
                <div className="absolute inset-[7px] flex items-center justify-center rounded-full bg-[var(--surface)] text-xs font-semibold text-zinc-900">
                  {project.progress}%
                </div>
              </div>
              <div>

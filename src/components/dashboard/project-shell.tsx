...
export function ProjectShell({
  ...
  return (
    <div className="min-h-screen bg-zinc-50">
      <div className="mx-auto grid min-h-screen w-full max-w-[1440px] gap-3 px-3 py-2 lg:grid-cols-[248px_minmax(0,1fr)] lg:px-4">
        <aside className="flex min-h-[calc(100vh-1rem)] flex-col rounded-lg border border-zinc-200 bg-white/90 p-4 shadow-sm">
          <div className="border-b border-zinc-200 pb-3">
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-zinc-500">
              Senda
            </p>
            <h1 className="mt-2 text-base font-semibold text-zinc-950">Portal cliente</h1>
          ...
          <div className="mt-4 space-y-2">
            ...
            <div className="rounded-md border border-zinc-200 bg-zinc-100 px-3 py-3">
          ...
          <div className="mt-5 flex-1 space-y-2 border-t border-zinc-200 pt-4">
            <p className="text-xs font-semibold uppercase tracking-wide text-zinc-500">
              Mis proyectos
            </p>
        ...
        <div className="min-w-0">
          <div className="mb-3 rounded-lg border border-zinc-200 bg-white/85 px-4 py-2 shadow-sm">

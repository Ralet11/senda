...
export function ProjectShell({ currentProjectId, currentProjectName, projects, children }: ProjectShellProps) {
  ...
  return <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]"><div className="grid min-h-screen grid-cols-[220px_minmax(0,1fr)]">
    <aside className="senda-project-sidebar flex min-h-screen flex-col border-r border-[var(--border-soft)] bg-[var(--surface-muted)] px-3 py-4">

...
export function ConversationFrame({ projectId, active, children }: ConversationFrameProps) {
  ...
  return <section className="grid min-h-[calc(100dvh-10rem)] gap-4 lg:grid-cols-[210px_minmax(0,1fr)]">
    <aside className="rounded-[1.35rem] border bg-white p-3 shadow-sm">
      <div className="px-1 pt-1"><p className="text-[10px] font-bold uppercase tracking-[.18em] text-[var(--brand)]">Conversaciones</p></div>
